...
def pack_packages(filename: str):
    # Wczytaj wymiary paczek
    dimensions = load_dimensions(os.path.join('data', 'product_list.csv'))

    # Wczytaj dane z pliku Zamowienie13.csv
    with open(os.path.join('data', 'orders', filename), newline='', encoding='utf-8') as zamowienie_file:
